(function() {
  ...
  window.StatisticsGatherer = StatisticsGatherer;
  window.StatisticsStorage = StatisticsStorage;
  window.StatisticsSender = StatisticsSender;
  window.StatisticsLogger = StatisticsLogger;
  window.UsageStatistics = UsageStatistics;
